...
const FoodCard = ({ food }) => {
    ...
    return (
        <div className="z-10 text-black bg-white p-5 rounded-2xl hover:drop-shadow-lg transition duration-400">
            <img className="h-40 w-full object-cover rounded-md" src={image} alt="" />
