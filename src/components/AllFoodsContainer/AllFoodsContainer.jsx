...
const AllFoodsContainer = () => {
    ...
    return (
        <div className={` ${isDark ? 'bg-gradient-to-r from-gray-800 to-gray-750 ' : 'bg-gradient-to-r from-slate-200 to-slate-100'} mt-20 p-10 mb-10 rounded-2xl transition-all duration-1000`}>
